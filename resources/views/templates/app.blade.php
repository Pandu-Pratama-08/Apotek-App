    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                {{-- check buat ngecek history loginnya ada apa tidak --}}
                @if (Auth::check())
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Route::is('data_buku.data') ? 'active' : '' }}"
                                href="{{ route('data_buku.data') }}">Data Buku</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ Route::is('kelola_akun') ? 'active' : '' }}"
                                href="{{ route('kelola_akun.kelola') }}">Data Akun</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.order')}}">Pembelian</a>
                        </li>
                        @else
                         <li class="nav-item">
